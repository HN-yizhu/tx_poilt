...
public class MerchChange {
	...
	public String getBankChangelNo() {
		return bankChangelNo;
	}
	public void setBankChangelNo(String bankChangelNo) {
		this.bankChangelNo = bankChangelNo;
	}
